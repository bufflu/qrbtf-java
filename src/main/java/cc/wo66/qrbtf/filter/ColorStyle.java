...
public class ColorStyle {
    ...
    public static int[][] getRGB(int style) {
        switch (style) {
            case 1: return BONE();
            case 2: return COOL();
            case 3: return HOT();
    ...
    private static  int[][] AUTUMN (){ return 
            new int[][]{
     ...
     private static  int[][] BONE (){ return 
            new int[][]{
     ...
     private static  int[][] COOL (){ return 
            new int[][]{
     ...
     private static  int[][] OCEAN (){ return 
            new int[][]{
            {0, 0, 0}, {0, 0, 0}, {0, 0, 2}, {0, 0, 2}, {0, 0, 4},
            {1, 0, 5}, {1, 0, 6}, {1, 0, 6}, {0, 0, 8}, {0, 0, 8},
            {0, 0, 10}, {0, 0, 10}, {0, 0, 12}, {0, 0, 12}, {1, 0, 14},
            {1, 0, 14}, {1, 0, 16}, {1, 0, 16}, {1, 0, 18}, {1, 0, 18},
            {0, 0, 20}, {0, 0, 20}, {0, 1, 22}, {0, 1, 22}, {0, 0, 24},
            {0, 0, 24}, {0, 0, 26}, {0, 0, 26}, {0, 0, 28}, {0, 0, 28},
            {0, 0, 30}, {1, 0, 31}, {0, 1, 32}, {0, 1, 32}, {0, 0, 34},
            {0, 0, 34}, {0, 0, 36}, {0, 0, 36}, {0, 0, 38}, {0, 0, 38},
            {1, 0, 40}, {1, 0, 40}, {1, 0, 42}, {1, 0, 42}, {0, 0, 44},
            {0, 0, 44}, {0, 0, 46}, {0, 0, 46}, {0, 0, 48}, {0, 1, 49},
            {0, 0, 50}, {0, 0, 50}, {0, 0, 52}, {0, 0, 52}, {0, 0, 54},
            {0, 0, 54}, {0, 0, 56}, {0, 0, 56}, {0, 1, 58}, {0, 1, 58},
            {0, 0, 60}, {0, 0, 60}, {0, 0, 62}, {0, 0, 62}, {0, 0, 64},
            {0, 0, 64}, {1, 0, 66}, {1, 0, 66}, {0, 1, 68}, {0, 1, 68},
            {0, 0, 70}, {0, 0, 70}, {0, 0, 72}, {0, 0, 72}, {0, 0, 74},
            {1, 1, 75}, {1, 0, 76}, {1, 0, 76}, {1, 0, 78}, {1, 0, 78},
            {0, 0, 80}, {0, 0, 80}, {0, 0, 82}, {0, 0, 82}, {0, 0, 86},
            {0, 0, 86}, {0, 2, 87}, {1, 3, 88}, {0, 5, 87}, {0, 7, 88},
            {1, 8, 89}, {0, 10, 90}, {0, 11, 91}, {0, 13, 92}, {0, 14, 95},
            {0, 15, 96}, {1, 16, 97}, {1, 18, 98}, {2, 19, 99}, {0, 21, 100},
            {1, 22, 101}, {0, 25, 102}, {0, 26, 103}, {0, 27, 104}, {1, 28, 105},
            {1, 30, 106}, {2, 31, 107}, {0, 34, 108}, {1, 35, 109}, {0, 37, 110},
            {0, 38, 111}, {0, 40, 112}, {0, 41, 113}, {0, 42, 114}, {0, 44, 115},
            {0, 46, 116}, {0, 47, 117}, {0, 49, 118}, {0, 50, 119}, {1, 51, 120},
            {0, 53, 121}, {0, 53, 121}, {1, 56, 123}, {0, 56, 123}, {1, 58, 125},
            {0, 59, 125}, {1, 62, 127}, {1, 62, 127}, {1, 65, 127}, {0, 66, 127},
            {2, 68, 129}, {0, 69, 129}, {1, 71, 133}, {0, 72, 133}, {0, 74, 135},
            {0, 75, 135}, {1, 77, 137}, {0, 78, 137}, {1, 80, 139}, {0, 81, 139},
            {1, 83, 141}, {0, 84, 141}, {0, 86, 143}, {0, 87, 143}, {2, 88, 145},
            {0, 89, 145}, {2, 91, 147}, {0, 93, 147}, {1, 95, 149}, {0, 96, 149},
            {1, 98, 151}, {0, 99, 151}, {1, 101, 153}, {0, 101, 153}, {2, 103, 155},
            {0, 105, 155}, {1, 107, 157}, {0, 108, 157}, {0, 110, 159}, {0, 111, 159},
            {0, 114, 161}, {0, 114, 161}, {0, 116, 163}, {0, 117, 163}, {1, 119, 165},
            {0, 120, 165}, {0, 123, 167}, {0, 123, 167}, {0, 125, 169}, {0, 125, 169},
            {4, 127, 169}, {5, 128, 170}, {8, 130, 171}, {10, 132, 173}, {11, 133, 174},
            {14, 136, 175}, {18, 136, 176}, {20, 138, 176}, {25, 138, 178}, {27, 140, 180},
            {32, 141, 180}, {34, 143, 182}, {37, 145, 183}, {39, 147, 183}, {41, 148, 184},
            {44, 151, 185}, {47, 152, 184}, {48, 153, 185}, {54, 154, 186}, {56, 156, 188},
            {60, 157, 190}, {62, 159, 191}, {66, 161, 193}, {67, 162, 192}, {73, 164, 195},
            {75, 166, 197}, {79, 166, 196}, {81, 168, 198}, {85, 168, 198}, {87, 171, 199},
            {91, 172, 201}, {92, 173, 200}, {96, 176, 201}, {98, 178, 203}, {102, 178, 202},
            {104, 180, 204}, {109, 181, 206}, {111, 183, 207}, {114, 184, 209}, {116, 187, 209},
            {120, 188, 211}, {122, 190, 213}, {125, 190, 212}, {128, 193, 215}, {133, 194, 215},
            {134, 195, 214}, {138, 196, 216}, {140, 199, 217}, {144, 200, 217}, {146, 202, 219},
            {151, 202, 219}, {153, 204, 221}, {157, 204, 222}, {159, 206, 222}, {162, 208, 224},
            {164, 210, 225}, {169, 211, 227}, {171, 213, 229}, {177, 214, 230}, {178, 215, 231},
            {180, 216, 230}, {183, 219, 231}, {186, 220, 232}, {188, 222, 232}, {191, 224, 233},
            {193, 226, 235}, {198, 227, 235}, {200, 229, 237}, {205, 229, 239}, {207, 232, 239},
            {209, 232, 240}, {212, 235, 241}, {217, 236, 243}, {217, 236, 243}, {223, 238, 245},
            {225, 240, 247}, {230, 241, 247}, {232, 243, 247}, {234, 243, 248}, {237, 247, 249},
            {240, 248, 250}, {240, 248, 250}, {246, 250, 251}, {248, 252, 253}, {253, 253, 255}, {255, 255, 255}
            };}

     private static  int[][] PINK (){ return  new int[][]{
     ...
     private static  int[][] RAINBOW (){ return  new int[][]{
            {253, 1, 0}, {255, 3, 0}, {254, 5, 0}, {254, 7, 0}, {254, 10, 0},
            {254, 14, 0}, {255, 15, 0}, {254, 17, 0}, {255, 20, 0}, {254, 22, 0},
            {255, 24, 1}, {255, 28, 0}, {255, 30, 0}, {255, 32, 0}, {255, 35, 0},
            {255, 37, 0}, {255, 40, 1}, {254, 43, 0}, {255, 45, 0}, {254, 48, 0},
            {255, 50, 0}, {254, 53, 0}, {255, 55, 0}, {254, 58, 0}, {255, 59, 0},
            {255, 63, 0}, {255, 64, 1}, {255, 68, 0}, {254, 70, 0}, {254, 74, 0},
            {255, 75, 0}, {254, 79, 0}, {255, 80, 0}, {254, 84, 0}, {255, 85, 0},
            {254, 89, 0}, {255, 90, 0}, {254, 94, 0}, {255, 95, 1}, {255, 99, 0},
            {255, 100, 0}, {255, 104, 0}, {255, 105, 0}, {255, 109, 0}, {255, 110, 0},
            {255, 113, 1}, {255, 115, 0}, {255, 119, 1}, {255, 121, 0}, {255, 123, 0},
            {255, 126, 0}, {255, 128, 1}, {255, 130, 1}, {254, 133, 0}, {255, 134, 1},
            {255, 138, 0}, {255, 139, 0}, {254, 142, 0}, {255, 144, 0}, {255, 148, 0},
            {255, 150, 0}, {255, 151, 0}, {255, 154, 0}, {255, 156, 0}, {255, 159, 0},
            {254, 162, 0}, {255, 165, 0}, {254, 167, 0}, {255, 170, 1}, {253, 173, 0},
            {255, 175, 0}, {254, 177, 1}, {255, 180, 1}, {255, 182, 0}, {255, 184, 2},
            {255, 187, 0}, {255, 190, 0}, {255, 193, 0}, {255, 195, 0}, {255, 197, 0},
            {255, 200, 0}, {254, 203, 0}, {255, 205, 0}, {255, 209, 1}, {255, 210, 2},
            {254, 213, 1}, {255, 214, 0}, {254, 218, 0}, {255, 219, 0}, {255, 223, 0},
            {255, 224, 0}, {254, 227, 0}, {255, 229, 0}, {255, 233, 0}, {255, 234, 0},
            {254, 237, 0}, {255, 239, 1}, {254, 242, 0}, {255, 244, 0}, {255, 247, 0},
            {255, 250, 0}, {253, 252, 1}, {252, 253, 0}, {248, 254, 0}, {244, 254, 0},
            {239, 255, 0}, {235, 254, 2}, {229, 255, 0}, {224, 255, 3}, {220, 255, 2},
            {215, 255, 0}, {209, 255, 0}, {205, 255, 0}, {200, 255, 0}, {195, 255, 1},
            {189, 255, 0}, {185, 255, 1}, {180, 255, 0}, {174, 255, 2}, {170, 255, 1},
            {165, 255, 1}, {162, 255, 0}, {155, 255, 1}, {150, 255, 0}, {145, 254, 2},
            {140, 255, 1}, {135, 254, 2}, {130, 255, 1}, {125, 255, 0}, {120, 255, 0},
            {115, 255, 0}, {110, 255, 0}, {105, 255, 0}, {100, 255, 0}, {94, 255, 1},
            {90, 255, 0}, {85, 255, 0}, {81, 255, 0}, {75, 255, 0}, {70, 255, 0},
            {65, 255, 1}, {60, 255, 0}, {55, 254, 1}, {50, 255, 0}, {44, 255, 0},
            {39, 255, 0}, {35, 255, 1}, {31, 255, 0}, {25, 254, 1}, {20, 255, 0},
            {15, 255, 0}, {10, 255, 1}, {7, 254, 0}, {3, 251, 4}, {1, 248, 7},
            {1, 244, 12}, {0, 240, 17}, {0, 235, 20}, {0, 230, 24}, {0, 225, 27},
            {0, 220, 36}, {1, 215, 41}, {0, 210, 46}, {0, 205, 52}, {0, 201, 55},
            {0, 195, 59}, {0, 190, 64}, {1, 186, 69}, {0, 180, 77}, {0, 175, 82},
            {0, 170, 84}, {0, 165, 89}, {1, 160, 94}, {0, 155, 98}, {0, 150, 105},
            {0, 146, 110}, {0, 140, 114}, {0, 135, 120}, {0, 131, 126}, {0, 125, 131},
            {0, 121, 136}, {0, 115, 140}, {0, 110, 143}, {0, 106, 148}, {0, 99, 155},
            {0, 95, 161}, {0, 90, 166}, {0, 84, 170}, {1, 80, 173}, {1, 76, 178},
            {0, 70, 184}, {0, 66, 189}, {0, 58, 196}, {0, 55, 200}, {0, 51, 205},
            {0, 45, 208}, {0, 41, 215}, {0, 36, 220}, {0, 29, 227}, {0, 25, 232},
            {0, 20, 237}, {0, 15, 240}, {0, 11, 243}, {2, 7, 246}, {3, 5, 248},
            {5, 3, 252}, {7, 2, 254}, {10, 0, 255}, {13, 0, 255}, {17, 0, 255},
            {20, 0, 255}, {23, 0, 254}, {26, 0, 255}, {30, 0, 254}, {33, 0, 253},
            {37, 0, 254}, {40, 0, 255}, {43, 0, 255}, {47, 0, 255}, {51, 0, 255},
            {53, 0, 255}, {57, 0, 255}, {60, 0, 254}, {63, 0, 255}, {66, 1, 255},
            {70, 0, 255}, {73, 0, 255}, {77, 0, 254}, {81, 0, 255}, {85, 0, 254},
            {87, 0, 253}, {91, 0, 254}, {93, 0, 255}, {97, 0, 255}, {100, 0, 255},
            {103, 0, 255}, {107, 0, 255}, {111, 0, 255}, {113, 0, 254}, {117, 0, 255},
            {120, 0, 255}, {123, 0, 255}, {127, 0, 255}, {131, 0, 254}, {135, 0, 255},
            {139, 0, 254}, {141, 0, 254}, {144, 0, 255}, {147, 0, 255}, {150, 0, 255},
            {152, 1, 255}, {156, 1, 255}, {161, 0, 255}, {165, 0, 255}, {167, 0, 254}, {170, 0, 255}
            };}

     private static  int[][] SPRING (){ return  new int[][]{
     ...
     private static  int[][] SUMMER (){ return  new int[][]{
     ...
     private static  int[][] WINTER (){ return  new int[][]{
